...
$poziv4="SELECT * FROM Polasci_trolejbusi WHERE ID=27";
$rezultat4=mysql_query($poziv4);
$ispis4=mysql_fetch_array($rezultat4);
$poziv5="SELECT * FROM Polasci_trolejbusi WHERE ID=29";
$rezultat5=mysql_query($poziv5);
$ispis5=mysql_fetch_array($rezultat5);
$poziv6="SELECT * FROM Polasci_trolejbusi WHERE ID=26";
$rezultat6=mysql_query($poziv6);
$ispis6=mysql_fetch_array($rezultat6);
$poziv7="SELECT * FROM Polasci_trolejbusi WHERE ID=28";
